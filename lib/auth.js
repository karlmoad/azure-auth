...
var AuthContext = (function(){
     ...
     * @param {boolean} authorized - indicator of the users authorization status
     */
        ...
        if(this._isCallback(obj)){
            ...
            if(obj.hasOwnProperty(this.CONSTANTS.ERROR_DESCRIPTION)){
                ...
                if(obj.requestInfo.stateMatch){
                    ...
                    xhr.send(JSON.stringify({authorization_token: azureToken}));
     ...
     * @private
     */
    AuthContext.prototype._isCallback = function(object){
    ...
    AuthContext.prototype._uuid = function () {
        ...
        if (cryptoObj && cryptoObj.getRandomValues) {
            ...
            // The client browser must be very old and we should error but we have to be nice to people
